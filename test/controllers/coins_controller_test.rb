...
class CoinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coin" do
    assert_difference('Coin.count') do
      post coins_url, params: { coin: { acronimo: @coin.acronimo, descricao: @coin.descricao, url_imagem: @coin.url_imagem } }
    end
  ...
  test "should update coin" do
    patch coin_url(@coin), params: { coin: { acronimo: @coin.acronimo, descricao: @coin.descricao, url_imagem: @coin.url_imagem } }
